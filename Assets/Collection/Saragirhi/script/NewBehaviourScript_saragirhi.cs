...
public class NewBehaviourScript_saragirhi : MonoBehaviour{

		int score=0;
		int max_score=100;
	    public Text loc;
		static NewBehaviourScript_saragirhi mins;
	    Stack<string> stk=new Stack<string>();

	public GameObject check;
	string checked_level=null;
	string target;
	    public static NewBehaviourScript_saragirhi instance 
	    {
		    get 
		    {
			if (mins == null) 
			{
				mins = new NewBehaviourScript_saragirhi ();
            }
			return mins;
			}
		}
