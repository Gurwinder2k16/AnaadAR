...
public class NewBehaviourScript_Santokh_sar : MonoBehaviour{

		int score=0;
		int max_score=100;
	    public Text loc;
	    static NewBehaviourScript_Santokh_sar mins;
	Stack<string> stk=new Stack<string>();
	public GameObject check;
	string checked_level=null;
	string target;
	    public static NewBehaviourScript_Santokh_sar instance 
	    {
		    get 
		    {
			if (mins == null) 
			{
				mins = new NewBehaviourScript_Santokh_sar ();
            }
			return mins;
			}
		}
