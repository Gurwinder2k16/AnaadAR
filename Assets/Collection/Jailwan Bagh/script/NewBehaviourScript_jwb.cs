...
public class NewBehaviourScript_jwb : MonoBehaviour{

		int score=0;
	    int max_score=500;
	    public Text loc;
		static NewBehaviourScript_jwb mins;
	    Stack<string> stk=new Stack<string>();
	    public GameObject check;
	    string checked_level=null;
    	string target;
	    public static NewBehaviourScript_jwb instance 
	    {
		    get 
		    {
			if (mins == null) 
			{
				mins = new NewBehaviourScript_jwb ();
            }
			return mins;
			}
		}
